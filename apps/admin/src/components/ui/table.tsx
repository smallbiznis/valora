...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "bg-bg-subtle/50 border-t border-border-subtle font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "hover:bg-bg-subtle/50 data-[state=selected]:bg-bg-subtle border-b border-border-subtle transition-colors",
        className
      )}
      {...props}
    />
