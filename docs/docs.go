    ...
    "paths": {
        ...
        "/invoices": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Finalized From",
                        "name": "finalized_from",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Finalized To",
                        "name": "finalized_to",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Total Min",
                        "name": "total_min",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Total Max",
                        "name": "total_max",
                        "in": "query"
                    },
                    {
        ...
        "/subscriptions/{id}/items": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Replace Subscription Items Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/usage": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Ingest Usage Request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "github_com_smallbiznis_railzway_internal_usage_domain.CreateIngestRequest": {
            ...
            "properties": {
                ...
                "idempotency_key": {
                    "description": "Required; must be non-empty. Uniqueness enforced at DB level.",
                    "type": "string",
                    "minLength": 1
                },
                "metadata": {
                ...
                "value": {
                    "description": "Usage can be zero or fractional; semantics resolved in rating.",
                    "type": "number"
                }
            }
        },
